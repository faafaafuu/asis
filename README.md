...
**Виджет расхода.** Строка на рабочем столе: `всего 7.8m · $1.42` — сколько
токенов и денег модель потратила через Суфлёр за всё время. При наведении —
разбивка за месяц и за сегодня, сколько потрачено на счёте OpenRouter всеми
программами, остаток и модель. Токены считаются по каждому ответу модели,
