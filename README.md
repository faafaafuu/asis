...
Модули собираются по единым правилам — описание, окно, голосовые команды и
инструменты через MCP, — чтобы свой модуль можно было подключить и выложить в
общую библиотеку. Формат и библиотека модулей в разработке.
...
- **Музыка.** «Включи музыку» — своя станция из настроек.
