...
const STRINGS = {
  ru: {
    ...
    "tasks.title": "Задачи",
    "tasks.review": "Спрашивать вечером, что успел",
    "tasks.reviewHint": "Ноа пройдёт по несделанным делам и предложит перенести то, до чего руки не дошли.",
    "tasks.reviewAt": "Во сколько спрашивать",
    "tasks.calendar": "Отправлять дела в Google-календарь",
    "tasks.calendarHint": "Нужен свой ключ: Google пускает к календарю только программы, зарегистрированные у него в облаке. Заведите проект в Google Cloud, включите Calendar API, создайте клиент типа «Desktop app» и впишите его сюда.",
    "tasks.clientId": "Идентификатор клиента",
    "tasks.clientSecret": "Секрет клиента",
    "tasks.connect": "Подключить",
    "tasks.forget": "Отключить",
    "speech.name": "Имя помощника",
    "speech.nameHint": "По этому имени к помощнику обращаются голосом, им же он себя называет. Лучше всего слышно имя из двух-трёх слогов, которое не встречается в обычной речи: «Ноа», «Джарвис», «Вега». Короткие и частые слова — «Макс», «Лена», «Мир» — помощник будет путать с разговором в комнате.",
    "speech.wake": "Отзываться на имя",
    "speech.wakeHint": "Назовите помощника по имени — и он начнёт слушать; можно сразу с вопросом: «Ноа, что такое альбедо». Микрофон для этого слушает постоянно. Распознавание идёт на этом компьютере, наружу ничего не уходит. Ctrl + Shift + Alt + Пробел включает и выключает ожидание, не открывая настройки, — и освобождает память, когда помощник не нужен.",
  ...
  en: {
    ...
    "tasks.title": "Tasks",
    "tasks.review": "Ask in the evening what got done",
    "tasks.reviewHint": "Noa walks through the unfinished work and offers to move what you did not get to.",
    "tasks.reviewAt": "When to ask",
    "tasks.calendar": "Send tasks to Google Calendar",
    "tasks.calendarHint": "Needs your own key: Google only lets in apps registered in its cloud. Create a project in Google Cloud, enable the Calendar API, create a Desktop app client and paste it here.",
    "tasks.clientId": "Client ID",
    "tasks.clientSecret": "Client secret",
    "tasks.connect": "Connect",
    "tasks.forget": "Disconnect",
    "speech.name": "Assistant name",
    "speech.nameHint": "You call the assistant by this name, and it introduces itself with it. Two or three syllables that never come up in normal speech work best: “Noa”, “Jarvis”, “Vega”. Short, common words get confused with conversation in the room.",
    "speech.wake": "Answer to its name",
    "speech.wakeHint": "Call the assistant by name and it starts listening; you can add the question right away: “Noa, what is albedo”. The microphone listens continuously for this. Recognition runs on this computer, nothing leaves it. Ctrl + Shift + Alt + Space turns listening on and off without opening settings, freeing memory when the assistant is not needed.",
