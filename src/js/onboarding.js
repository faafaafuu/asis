...
const CATALOG = [
  { name: "qwen3.5:4b", size: "3.4 ГБ", note: "точная и быстрая, оставляет место распознаванию речи", top: true },
  { name: "qwen3.5:9b", size: "6.6 ГБ", note: "точнее всех; вместе с голосом нужна карта от 12 ГБ", top: true },
