...
| Левый Shift + пробел | посмотреть на окно, где вы работаете, и спросить о нём |
| Пробел в окне объяснения | коротко — прочитать вслух или замолчать; зажать на полсекунды — слушать |
...
**Левый Shift + пробел** в любом окне — терминале, браузере, Telegram — и NOAH видит, что в нём сейчас на экране: последнее, а не всё окно. Дальше просто спрашивайте голосом: «объясни путь» про только что запущенный \`traceroute\`, «по какому адресу эта выставка» про пост в канале. Ответ — простыми словами, без зачитывания адресов и цифр. «Добавь на субботу сходить туда» заведёт дело с тем, что было в посте.

Текст окна читается средствами Windows на вашем компьютере; модели уходит только видимая часть, до трёх тысяч знаков. Посреди набора текста Shift + пробел остаётся заглавной буквой и пробелом.
...
| Left Shift + Space | look at the window you work in and ask about it |
| Esc | stop the answer |
