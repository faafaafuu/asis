...
const T = {
  ru: {
    ...
    title: ["Оболочка для ИИ.", "Модули без кода."],
    ...
    how: [
      ["Поставьте оболочку", "Скачайте NOAH. Он живёт в трее, слышит голос и уже умеет десятки вещей из коробки."],
    ...
    featTitle: "Одна оболочка — бесконечно много рук",
    ...
    multi: ["Мультимодальность", "Говорите голосом, пишите текстом, в Telegram, выделяйте текст на экране — оболочка понимает всё и зовёт нужный модуль."],
    ...
    faq: [
      ...
      ["Это бесплатно?", "Да. Оболочка бесплатная, своя модель через Ollama работает без ключей и интернета. Платите только облачному сервису, если выберете его."],
    ],
  ...
  en: {
    ...
    title: ["A shell for AI.", "Modules, no code."],
    ...
    how: [
      ["Install the shell", "Download NOAH. It lives in the tray, hears your voice and already does dozens of things."],
    ...
    featTitle: "One shell — endless hands",
    ...
    multi: ["Multimodal", "Speak, type, message it in Telegram, select text on screen — the shell understands and calls the right module."],
    ...
    faq: [
      ...
      ["Is it free?", "Yes. The shell is free, and a local model through Ollama works without keys or internet. You pay only a cloud service if you choose one."],
    ],
