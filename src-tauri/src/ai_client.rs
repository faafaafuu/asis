...
pub trait AiProvider: Send + Sync {
    ...
    /// Разговор со своими указаниями: история и новая реплика. Так говорят
    /// репетитор урока и помощник по окну.
    ///
    /// Не `ask`: у того указания про выделенный термин и ответ в пару фраз, а
    /// здесь нужно объяснять — по шагам, с примером, столько, сколько требует
    /// непонятое. `long` — подробный разбор раздела урока, ему нужен потолок
    /// длины в несколько раз выше обычного.
    ///
