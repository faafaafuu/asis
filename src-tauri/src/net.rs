...
//! инициализации через JNI, и без неё падает при первом же запросе с паникой
//! «Expect rustls-platform-verifier to be initialized». Для человека это
//! выглядело как «внутренняя ошибка» на любое действие, где нужна сеть, —
//! от проверки ключа до объяснения слова.
//!
